...
# Specify the URL or file path to the doctor's image (used as a logo)
doctor_logo_url = "./doctor.png"  # Replace with the actual URL or file path
...
st.sidebar.image(doctor_logo_url, use_column_width=True, width=150, output_format="PNG")
